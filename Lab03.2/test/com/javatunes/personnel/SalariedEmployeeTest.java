...
public class SalariedEmployeeTest {
  ...
  public void setUp() throws Exception {
    employee = new SalariedEmployee(
        "John Smith", new Date(0), 1000.00);
  }

  @Test
  public void pay() {
    assertEquals(1000.00, employee.pay(),0.005);
  }

  @Test
  public void payTaxes() {
    assertEquals(1000.00 * TaxPayer.SALARIED_TAX_RATE, employee.payTaxes(),0.005);
  }
  ...
  public void equals_different(){
    Employee employee2 = new SalariedEmployee("Julian", new Date(0),1000.00);
